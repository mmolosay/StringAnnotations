...
/**
 * Implementation of [ClickableAnnotationProcessor] for Compose UI.
 */
internal class ClickableAnnotationProcessor : ClickableAnnotationProcessor<ComposeSpan>() {

    override fun makeSpan(value: ClickableSpan): ComposeSpan =
        TODO() // https://developer.android.com/jetpack/compose/text#click-with-annotation
}